...
use crate::lc_libs::{lc_utils::get_choix, Categorie, Compte};
...
impl LivreComptable {
	pub fn supp_compte(&mut self, var_app: &VarsApp) -> bool {

		let language = supprime_locale::set_supprime_lang(&var_app);
	...
	pub fn supp_categorie(&mut self, var_app: &VarsApp) -> bool {
		...
		if !self.TMP_CATEGORIES.is_empty() {
